    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Login using your phone number</p>
        </div>
        ...
        <div className="card p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  title="Enter a valid Indian phone number (e.g. +91 9876543210)"
                  value={phone}
          ...
          <div className="mt-6 text-center">
            ...
            <Link to="/signup" className="text-primary-600 hover:text-primary-500 dark:text-primary-400 font-medium">Create a new account</Link>
          </div>
        </div>

        <div className="text-center">
          <Link to="/" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm">← Back to Homepage</Link>
        </div>
      </div>
    </div>
  );
