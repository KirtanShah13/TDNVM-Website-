    ...
    <div className="py-16">
      ...
      <section className="bg-white dark:bg-gray-900 py-16 px-4 sm:px-6 lg:px-8 rounded-xl shadow-lg">
        <div className="max-w-6xl mx-auto text-center">
          ...
          {loading ? (
            <p className="text-gray-500 dark:text-gray-400">Loading leadership history...</p>
          ) : (
            <div className="overflow-x-auto rounded-lg shadow border border-gray-200 dark:border-gray-700">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-100 dark:bg-gray-800">
                  ...
                  <th className="border border-gray-300 px-2 py-1 text-left">President Name</th>
                  <th className="border border-gray-300 px-2 py-1 text-left">Presidency Year</th>
                  <th className="border border-gray-300 px-2 py-1 text-left">Secretary Name</th>
                  <th className="border border-gray-300 px-2 py-1 text-left">Secretary Year</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                  {leaders.length > 0 ? (
                    leaders.map((entry, index) => (
                      <tr key={entry.no || index} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"> {/* Fallback key to index */}
